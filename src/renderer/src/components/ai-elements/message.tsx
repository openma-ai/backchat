...
export const MessageBranchPrevious = ({
  ...
  return (
    <Button
      aria-label={t("shell.previousBranch")}
...
// MessageResponse is the streaming-markdown bubble (Streamdown + plugins).
// Stripped from this Phase 3 vendor copy so we don't ship 3 MB of language
// grammars + KaTeX + mermaid we aren't using yet. Phase 5 reinstates it.
