...
export function Archive() {
  ...
  return (
    <div>
      <h2 className="mb-1 text-base font-medium text-fg">Archived sessions</h2>
      ...
      {error && (
        <div className="rounded-md border border-danger/40 bg-danger-subtle/40 px-3 py-2 text-[12px] text-danger">
      ...
      {rows !== null && !error && rows.length === 0 && (
        <div className="rounded-md border border-border/60 bg-bg-surface/40 px-3 py-6 text-center text-xs text-fg-subtle">
            ...
            return (
              <li
                ...
                className={cn(
                  ...
                  "border border-border/60 bg-bg-surface/40",
                )}
              >
                <div className="min-w-0 flex-1">
                  <div className="truncate text-[13px] text-fg" title={label}>
                    {label}
                  </div>
