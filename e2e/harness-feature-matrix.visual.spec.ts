...
test("captures all 45 GUI features × all 7 harnesses with real visible targets", async ({
  ...
  await writeFile(
    ...
    JSON.stringify({
      ...
      routing: [
        { harness: "Claude", provider: "DeepSeek Anthropic", status: "LIVE-E2E", detail: "claude-agent-acp 0.64.2; deepseek-v4-flash" },
        { harness: "Codex", provider: "Codex default", status: "LIVE-E2E", detail: "codex-acp 1.1.9; excluded from DeepSeek as requested" },
        { harness: "Cursor", provider: "Cursor account default", status: "LIVE-E2E", detail: "official Cursor 2026.07.23 account session; runtime-default" },
        { harness: "Pi", provider: "DeepSeek Anthropic", status: "LIVE-E2E", detail: "pi-acp 0.0.33 with Pi 0.83.0; deepseek-v4-flash" },
        { harness: "OpenCode", provider: "DeepSeek Anthropic", status: "LIVE-E2E", detail: "OpenCode 1.18.12; deepseek-v4-flash" },
        { harness: "Kilo", provider: "DeepSeek Anthropic", status: "LIVE-E2E", detail: "Kilo 7.4.19; deepseek-v4-flash" },
        { harness: "Kimi Code", provider: "DeepSeek Anthropic", status: "LIVE-E2E", detail: "@moonshot-ai/kimi-code 0.33.0 via kimi acp; deepseek-v4-flash" },
      ],
      notes: [
        "LIVE-E2E is reserved for a real Electron GUI run executed through visible user interactions.",
        "REPLAY-ONLY means a versioned or synthetic ACP event was projected through the renderer; it is diagnostic evidence and does not count as acceptance.",
